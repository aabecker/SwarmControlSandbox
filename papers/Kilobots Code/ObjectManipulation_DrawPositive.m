%% Object Manipulation Positive Potential Field Drawing
% In this code we use arduino and our vision system to interperate where
% the positive force on the swarm of robots would be and draws it on the
% map.
%           See also REIGONCODE, POSITIVEFLOW.
